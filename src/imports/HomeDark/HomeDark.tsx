import svgPaths from "./svg-frbab6wso6";
...
function Background() {
  return (
    <div className="absolute bg-[#0b0f14] content-stretch flex flex-col items-start left-0 pb-[32px] pt-[31px] px-[384px] right-0 top-[1829.95px]" data-name="Background">
      <Container4 />
    </div>
  );
}
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 1">
      <div className="flex flex-col font-['Fredoka:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#f4f7f9] text-[56px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="mb-0">
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 5">
      <div className="flex flex-col font-['Fredoka:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#b5c0c8] text-[20px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Background1() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 overflow-clip pb-[96px] pl-[352px] pr-[360px] pt-[64px] right-0 top-0" data-name="Background" style={{ backgroundImage: "linear-gradient(135deg, rgb(15, 20, 26) 0%, rgb(21, 28, 36) 45%, rgb(12, 42, 42) 100%)" }}>
      <div className="absolute bg-[rgba(255,107,107,0.2)] right-[-50px] rounded-[100px] size-[200px] top-[-50px]" data-name="Overlay" />
      <div className="absolute bg-[rgba(78,205,196,0.25)] bottom-[-30px] left-[-30px] rounded-[75px] size-[150px]" data-name="Overlay" />
      <Container5 />
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Fredoka:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#f4f7f9] text-[40px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Paragraph() {
  return (
    <div className="h-[67.47px] leading-[0] relative shrink-0 w-[151.98px]" data-name="Paragraph">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Fredoka:SemiBold',sans-serif] font-semibold h-[36px] justify-center left-0 text-[#f4f7f9] text-[28.8px] top-[49.41px] w-[152.298px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Container20() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Nunito:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#b5c0c8] text-[16px] w-full">
...
function BackgroundBorderShadow() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[64px] w-full" data-name="Background+Border+Shadow" style={{ backgroundImage: "linear-gradient(159.915deg, rgba(255, 107, 107, 0.18) 0%, rgba(16, 20, 26, 0.92) 55%, rgba(255, 107, 107, 0.12) 100%)" }}>
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[15.19px] items-start p-[33px] relative size-full">
          <Container17 />
          <Container19 />
          <div className="absolute bg-[rgba(255,107,107,0.22)] right-[-39px] rounded-[70px] size-[140px] top-[-49px]" data-name="Overlay" />
          <div className="absolute bottom-[-64.94px] flex items-center justify-center left-[-34.94px] size-[131.886px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "0" } as React.CSSProperties}>
            <div className="-rotate-6 flex-none">
              <div className="relative rounded-[512px] size-[120px]" data-name="Border">
                <div aria-hidden="true" className="absolute border border-[rgba(255,107,107,0.4)] border-dashed inset-0 pointer-events-none rounded-[512px]" />
              </div>
            </div>
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(255,107,107,0.3)] border-solid inset-0 pointer-events-none rounded-[64px] shadow-[0px_18px_35px_0px_rgba(0,0,0,0.45)]" />
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[67.47px] leading-[0] relative shrink-0 w-[169.94px]" data-name="Paragraph">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Fredoka:SemiBold',sans-serif] font-semibold h-[36px] justify-center left-0 text-[#f4f7f9] text-[28.8px] top-[49.4px] w-[170.272px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function BackgroundBorderShadow1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[64px] w-full" data-name="Background+Border+Shadow" style={{ backgroundImage: "linear-gradient(159.975deg, rgba(78, 205, 196, 0.18) 0%, rgba(16, 20, 26, 0.92) 55%, rgba(78, 205, 196, 0.12) 100%)" }}>
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[15.375px] items-start p-[33px] relative size-full">
          <Container24 />
          <Container26 />
          <div className="absolute bg-[rgba(78,205,196,0.22)] right-[-39px] rounded-[70px] size-[140px] top-[-49px]" data-name="Overlay" />
          <div className="absolute bottom-[-64.93px] flex items-center justify-center left-[-34.94px] size-[131.886px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "0" } as React.CSSProperties}>
            <div className="-rotate-6 flex-none">
              <div className="relative rounded-[512px] size-[120px]" data-name="Border">
                <div aria-hidden="true" className="absolute border border-[rgba(78,205,196,0.4)] border-dashed inset-0 pointer-events-none rounded-[512px]" />
              </div>
            </div>
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(78,205,196,0.3)] border-solid inset-0 pointer-events-none rounded-[64px] shadow-[0px_18px_35px_0px_rgba(0,0,0,0.45)]" />
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[67.47px] leading-[0] relative shrink-0 w-[233.5px]" data-name="Paragraph">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Fredoka:SemiBold',sans-serif] font-semibold h-[36px] justify-center left-0 text-[#f4f7f9] text-[28.8px] top-[49.4px] w-[233.882px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Container33() {
  return (
    <div className="h-[135.94px] relative shrink-0 w-full" data-name="Container">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Regular',sans-serif] font-normal h-[28px] justify-center leading-[0] left-0 text-[#b5c0c8] text-[16px] top-[13px] w-[434.179px]">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Regular',sans-serif] font-normal h-[28px] justify-center leading-[0] left-[140.31px] text-[#b5c0c8] text-[16px] top-[40.18px] w-[345.715px]">
        <p className="leading-[27.2px]">to help keep our feeding stations stocked for the</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Regular',sans-serif] font-normal h-[82px] justify-center leading-[0] left-0 text-[#b5c0c8] text-[16px] top-[94.56px] w-[486.26px]">
...
function BackgroundBorderShadow2() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[64px] w-full" data-name="Background+Border+Shadow" style={{ backgroundImage: "linear-gradient(159.975deg, rgba(244, 162, 97, 0.18) 0%, rgba(16, 20, 26, 0.92) 55%, rgba(244, 162, 97, 0.12) 100%)" }}>
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start p-[33px] relative size-full">
          <Container30 />
          <Container32 />
          <div className="absolute bg-[rgba(244,162,97,0.22)] right-[-39px] rounded-[70px] size-[140px] top-[-49px]" data-name="Overlay" />
          <div className="absolute bottom-[-64.93px] flex items-center justify-center left-[-34.94px] size-[131.886px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "0" } as React.CSSProperties}>
            <div className="-rotate-6 flex-none">
              <div className="relative rounded-[512px] size-[120px]" data-name="Border">
                <div aria-hidden="true" className="absolute border border-[rgba(244,162,97,0.4)] border-dashed inset-0 pointer-events-none rounded-[512px]" />
              </div>
            </div>
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(244,162,97,0.3)] border-solid inset-0 pointer-events-none rounded-[64px] shadow-[0px_18px_35px_0px_rgba(0,0,0,0.45)]" />
    </div>
  );
}
...
function Background2() {
  return (
    <div className="absolute bg-gradient-to-b content-stretch flex flex-col from-[#0f141a] items-start left-0 overflow-clip px-[360px] py-[80px] right-0 to-[#0c1117] top-[532px] via-[#141b23] via-[45%]" data-name="Background">
      <div className="absolute bg-[rgba(255,107,107,0.18)] blur-[0px] left-[-80px] rounded-[130px] size-[260px] top-[-120px]" data-name="Overlay+Blur" />
      <div className="absolute bg-[rgba(78,205,196,0.16)] bottom-[-140px] right-[-90px] rounded-[150px] size-[300px]" data-name="Overlay" />
      <Container14 />
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 4">
      <div className="flex flex-col font-['Fredoka:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#f4f7f9] text-[28px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Heading4() {
  return (
    <div className="content-stretch flex flex-col items-center opacity-90 pb-[17px] relative shrink-0 w-full" data-name="Heading 6">
      <div className="flex flex-col font-['Fredoka:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#f4f7f9] text-[17.6px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
  ...
  return (
    <div className="max-w-[900px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col items-center max-w-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[15px] items-center max-w-[inherit] px-[24px] relative w-full">
          <Heading2 />
          <Heading4 />
          <div className="bg-[#ff6b6b] content-stretch flex items-center justify-center min-w-[64px] px-[40px] py-[12px] relative rounded-[24px] shrink-0" data-name="Component 2">
            <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[24px] shadow-[0px_3px_1px_-2px_rgba(0,0,0,0.2),0px_2px_2px_0px_rgba(0,0,0,0.14),0px_1px_5px_0px_rgba(0,0,0,0.12)]" data-name="Link:shadow" />
            <div className="flex flex-col font-['Fredoka:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[16px] text-[rgba(0,0,0,0.87)] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function BackgroundHorizontalBorder() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 pb-[64px] pt-[65px] px-[510px] right-0 top-[1538.23px]" data-name="Background+HorizontalBorder" style={{ backgroundImage: "linear-gradient(134.874deg, rgba(255, 107, 107, 0.22) 0%, rgba(78, 205, 196, 0.18) 60%, rgba(230, 74, 74, 0.28) 100%)" }}>
      <div aria-hidden="true" className="absolute border-[rgba(255,107,107,0.25)] border-solid border-t inset-0 pointer-events-none" />
      <Container35 />
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[1937.98px] relative shrink-0 w-full z-[1]" data-name="Container">
      <Background />
      <Background1 />
      <Background2 />
...
export default function HomeDark() {
  return (
    <div className="content-stretch flex flex-col isolate items-start relative size-full" data-name="Home dark" style={{ backgroundImage: "linear-gradient(90deg, rgb(15, 20, 26) 0%, rgb(15, 20, 26) 100%), linear-gradient(90deg, rgb(15, 20, 26) 0%, rgb(15, 20, 26) 100%), linear-gradient(90deg, rgb(18, 18, 18) 0%, rgb(18, 18, 18) 100%)" }}>
      <Header />
      <Container3 />
    </div>
  );
