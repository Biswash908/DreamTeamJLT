import svgPaths from "./svg-3584bzkch1";
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Fredoka:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#2d3436] text-[40px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-center max-w-[640px] relative shrink-0 w-[640px]" data-name="Container">
      <div className="flex flex-col font-['Nunito:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#636e72] text-[16px] text-center whitespace-nowrap">
...
function Background1() {
  return (
    <div className="grid grid-cols-[_56px] grid-rows-[_56px] relative rounded-[18px] shrink-0 size-[56px]" data-name="Background" style={{ backgroundImage: "linear-gradient(135deg, rgba(46, 125, 50, 0.25) 0%, rgba(46, 125, 50, 0.6) 100%)" }}>
      <div className="col-1 overflow-clip relative row-1 shrink-0 size-[30px]" data-name="Component 3">
        <div className="absolute inset-[16.67%_8.33%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25 20">
            <path d={svgPaths.p1cf08200} fill="var(--fill-0, #2E7D32)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 4">
      <div className="flex flex-col font-['Fredoka:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#2d3436] text-[25.6px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Container10() {
  return (
    <div className="col-1 content-stretch flex flex-col items-start justify-self-stretch relative row-1 self-start shrink-0" data-name="Container">
      <div className="flex flex-col font-['Nunito:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#636e72] text-[16px] whitespace-nowrap">
  ...
  return (
    <div className="col-1 justify-self-stretch relative row-1 self-start shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.91px] relative w-full">
        <div className="flex flex-col font-['Nunito:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#636e72] text-[12px] tracking-[1.44px] uppercase whitespace-nowrap">
...
function Container13() {
  return (
    <div className="h-full relative shrink-0 w-[101.23px]" data-name="Container">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Regular',sans-serif] font-normal h-[21px] justify-center leading-[0] left-0 text-[#636e72] text-[14px] top-[9.5px] w-[101.587px]">
...
function Container14() {
  return (
    <div className="h-full relative shrink-0 w-[107.14px]" data-name="Container">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:SemiBold',sans-serif] font-semibold h-[21px] justify-center leading-[0] left-0 text-[#2d3436] text-[14px] top-[9.5px] w-[107.506px]">
...
function Container16() {
  return (
    <div className="h-full relative shrink-0 w-[127.81px]" data-name="Container">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Regular',sans-serif] font-normal h-[21px] justify-center leading-[0] left-0 text-[#636e72] text-[14px] top-[9.5px] w-[128.208px]">
...
function Container17() {
  return (
    <div className="h-full relative shrink-0 w-[82.5px]" data-name="Container">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Bold',sans-serif] font-bold h-[21px] justify-center leading-[0] left-0 text-[#2d3436] text-[14px] top-[9.5px] w-[82.827px]">
...
function OverlayBorder() {
  return (
    <div className="bg-[rgba(46,125,50,0.08)] col-1 h-[125.13px] justify-self-stretch relative rounded-[48px] row-2 shrink-0" data-name="Overlay+Border">
      <div aria-hidden="true" className="absolute border border-[rgba(46,125,50,0.4)] border-dashed inset-0 pointer-events-none rounded-[48px]" />
...
function OverlayVerticalBorder() {
  return (
    <div className="bg-[rgba(78,205,196,0.08)] col-1 justify-self-stretch relative rounded-[48px] row-3 self-start shrink-0" data-name="Overlay+VerticalBorder">
...
function BackgroundBorderShadow() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[64px] w-full" data-name="Background+Border+Shadow" style={{ backgroundImage: "linear-gradient(159.979deg, rgba(46, 125, 50, 0.12) 0%, rgb(255, 255, 255) 50%, rgba(46, 125, 50, 0.18) 100%)" }}>
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start p-[33px] relative size-full">
          <Container8 />
          <Container9 />
          <div className="bg-[#2e7d32] min-w-[64px] relative rounded-[24px] shrink-0 w-full" data-name="Component 2">
            <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center min-w-[inherit] px-[24px] py-[11.2px] relative w-full">
                <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[24px] shadow-[0px_3px_1px_-2px_rgba(0,0,0,0.2),0px_2px_2px_0px_rgba(0,0,0,0.14),0px_1px_5px_0px_rgba(0,0,0,0.12)]" data-name="Link:shadow" />
                <div className="flex flex-col font-['Fredoka:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[16px] text-center text-white whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
      ...
      <div aria-hidden="true" className="absolute border border-[rgba(46,125,50,0.3)] border-solid inset-0 pointer-events-none rounded-[64px] shadow-[0px_20px_40px_0px_rgba(46,125,50,0.2)]" />
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 5">
      <div className="flex flex-col font-['Fredoka:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#2d3436] text-[20px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
  ...
  return (
    <div className="h-[40.03px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Regular',sans-serif] font-normal h-[21px] justify-center leading-[0] left-0 text-[#636e72] text-[14px] top-[9.5px] w-[379.938px]">
        ...
        <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Regular',sans-serif] font-normal h-[21px] justify-center leading-[0] left-[122.77px] text-[#636e72] text-[14px] top-[29.52px] w-[260.831px]">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start leading-[0] pb-[21.01px] pt-[3px] relative text-[14px] w-full">
        <div className="flex flex-col font-['Nunito:Regular',sans-serif] font-normal justify-center mb-[-20px] relative shrink-0 text-[#636e72] whitespace-nowrap">
...
function OverlayBorderShadow() {
  return (
    <div className="bg-[rgba(255,107,107,0.05)] col-1 justify-self-stretch relative rounded-[64px] row-1 self-start shrink-0" data-name="Overlay+Border+Shadow">
      <div aria-hidden="true" className="absolute border border-[rgba(255,107,107,0.25)] border-solid inset-0 pointer-events-none rounded-[64px] shadow-[0px_14px_28px_0px_rgba(255,107,107,0.15)]" />
...
function Container27() {
  return (
    <div className="content-stretch flex h-[20.02px] items-center pb-[1.02px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Nunito:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#2d3436] text-[14px] whitespace-nowrap">
        <p className="leading-[20px]">{`Email: `}</p>
      </div>
      <div className="h-[19px] relative shrink-0 w-[193.75px]" data-name="Component 5">
        <div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Bold',sans-serif] font-bold h-[21px] justify-center leading-[0] left-0 text-[#2d3436] text-[14px] top-[9.5px] w-[194.101px]">
...
function Container28() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Nunito:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#2d3436] text-[14px] w-full">
...
function OverlayBorderShadow1() {
  return (
    <div className="bg-[rgba(78,205,196,0.06)] col-1 justify-self-stretch relative rounded-[64px] row-2 self-start shrink-0" data-name="Overlay+Border+Shadow">
      <div aria-hidden="true" className="absolute border border-[rgba(78,205,196,0.25)] border-solid inset-0 pointer-events-none rounded-[64px] shadow-[0px_14px_28px_0px_rgba(78,205,196,0.14)]" />
      <div className="content-stretch flex flex-col gap-[12px] items-start p-[29px] relative w-full">
        <Container25 />
        <Container26 />
      </div>
...
function Container29() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Nunito:Italic',sans-serif] font-normal italic justify-center leading-[0] relative shrink-0 text-[#636e72] text-[14px] text-center whitespace-nowrap">
...
function Overlay() {
  return (
    <div className="bg-[rgba(255,107,107,0.08)] relative rounded-[15984px] shrink-0 w-full" data-name="Overlay">
...
function Background() {
  return (
    <div className="bg-gradient-to-b from-[#fff9f5] relative shrink-0 to-[#f6fffd] via-[45%] via-white w-full z-[1]" data-name="Background">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start px-[360px] py-[80px] relative w-full">
          <div className="absolute bg-[rgba(255,107,107,0.08)] right-[-80px] rounded-[130px] size-[260px] top-[-120px]" data-name="Overlay" />
          <div className="absolute bg-[rgba(78,205,196,0.08)] bottom-[-140px] left-[-90px] rounded-[160px] size-[320px]" data-name="Overlay" />
          <Container3 />
        </div>
      </div>
    </div>
...
export default function Donate() {
  return (
    <div className="content-stretch flex flex-col isolate items-start relative size-full" data-name="Donate" style={{ backgroundImage: "linear-gradient(90deg, rgb(255, 249, 245) 0%, rgb(255, 249, 245) 100%), linear-gradient(90deg, rgb(255, 249, 245) 0%, rgb(255, 249, 245) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Header />
      <Background />
    </div>
  );
